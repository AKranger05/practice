...
export function FloatingCartButton({ onClick }: FloatingCartButtonProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 p-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <button
        type="button"
        onClick={onClick}
        className={cn(
          "w-full max-w-lg mx-auto flex items-center justify-center gap-3 px-6 py-4 rounded-xl",
